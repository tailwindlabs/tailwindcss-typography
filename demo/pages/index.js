...
export default () => {
  return (
    <div className="antialiased text-gray-900">
      ...
      <div className="px-4 py-10 sm:px-6 sm:py-12 lg:py-16 lg:px-8">
        <article>
          <h1 className="sr-only">Tailwind CSS Typography</h1>
          <div className="space-y-10 sm:space-y-12 lg:space-y-20 xl:space-y-24">
            <div className="max-w-3xl mx-auto lg:max-w-4xl xl:max-w-6xl">
            ...
            <div className="mx-auto prose-sm prose sm:prose lg:prose-lg xl:prose-2xl">
              ...
              <Fragment>
                <h2>
                  Full Bleed Layout <code>.prose-bleed</code>
                </h2>

                <p>
                  Bleed is a printing term that describes a document that has graphics, images,
                  colors, or elements that reach to the edge of the paper.
                </p>

                <p>
                  Use <code>.prose-bleed</code> to bleed content outside the container width.
                </p>
                ...
                <div className="prose-bleed">
                  <img
                    ...
                    alt=""
                    className="object-cover w-full mx-auto max-w-7xl max-h-96"
                  />
                </div>

                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum libero
                  laudantium, nesciunt quae possimus, amet labore voluptatum nobis, dignissimos enim
                  eos voluptas! Eos possimus cumque suscipit beatae perferendis perspiciatis est!
                </p>
              </Fragment>
            </div>
          </div>
