...
export default function Index() {
  return (
    <div className="antialiased text-gray-900 dark:bg-gray-900">
      <Head>
            ...
            <div className="space-y-10 sm:space-y-0 sm:flex sm:items-center sm:justify-between">
              ...
              <div>
                <a
                  ...
                  className="inline-flex items-center py-2 px-3 space-x-2 rounded-md bg-gray-800 text-gray-300 text-sm leading-5 font-medium shadow-lg hover:bg-gray-700 transition ease-in-out duration-100 dark:text-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600"
                >
                  <svg className="h-5 w-5 fill-gray-500 dark:fill-gray-400" viewBox="0 0 20 20">
                    <path
                      fillRule="evenodd"
