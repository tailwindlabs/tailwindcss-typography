...
let defaultModifiers = {
  ...
  slate: {
    css: {
      ...
      '--tw-prose-kbd': colors.slate[700],
      '--tw-prose-kbd-bg': colors.slate[100],
      '--tw-prose-kbd-border': colors.slate[300],
      ...
      '--tw-prose-invert-kbd': colors.slate[300],
      '--tw-prose-invert-kbd-bg': colors.slate[800],
      '--tw-prose-invert-kbd-border': colors.slate[700],
  ...
  gray: {
    css: {
      ...
      '--tw-prose-kbd': colors.gray[700],
      '--tw-prose-kbd-bg': colors.gray[100],
      '--tw-prose-kbd-border': colors.gray[300],
      ...
      '--tw-prose-invert-kbd': colors.gray[300],
      '--tw-prose-invert-kbd-bg': colors.gray[800],
      '--tw-prose-invert-kbd-border': colors.gray[700],
      '--tw-prose-invert-code': colors.white,
  ...
  zinc: {
    css: {
      ...
      '--tw-prose-kbd': colors.zinc[700],
      '--tw-prose-kbd-bg': colors.zinc[100],
      '--tw-prose-kbd-border': colors.zinc[300],
      ...
      '--tw-prose-invert-kbd': colors.zinc[300],
      '--tw-prose-invert-kbd-bg': colors.zinc[800],
      '--tw-prose-invert-kbd-border': colors.zinc[700],
      '--tw-prose-invert-code': colors.white,
  ...
  neutral: {
    css: {
      ...
      '--tw-prose-kbd': colors.neutral[700],
      '--tw-prose-kbd-bg': colors.neutral[100],
      '--tw-prose-kbd-border': colors.neutral[300],
      ...
      '--tw-prose-invert-kbd': colors.neutral[300],
      '--tw-prose-invert-kbd-bg': colors.neutral[800],
      '--tw-prose-invert-kbd-border': colors.neutral[700],
      '--tw-prose-invert-code': colors.white,
  ...
  stone: {
    css: {
      ...
      '--tw-prose-kbd': colors.stone[700],
      '--tw-prose-kbd-bg': colors.stone[100],
      '--tw-prose-kbd-border': colors.stone[300],
      ...
      '--tw-prose-invert-kbd': colors.stone[300],
      '--tw-prose-invert-kbd-bg': colors.stone[800],
      '--tw-prose-invert-kbd-border': colors.stone[700],
      '--tw-prose-invert-code': colors.white,
  ...
  invert: {
    css: {
      ...
      '--tw-prose-kbd-border': 'var(--tw-prose-invert-kbd-border)',
    ...
    css: [
      {
        ...
        kbd: {
          ...
          borderColor: 'var(--tw-prose-kbd-border)',
          borderWidth: '1px',
