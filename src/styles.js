...
let defaultModifiers = {
  ...
  slate: {
    css: {
      ...
      '--tw-prose-rules': colors.slate[200],
      ...
      '--tw-prose-invert-rules': colors.slate[700],
  ...
  gray: {
    css: {
      ...
      '--tw-prose-rules': colors.gray[200],
      ...
      '--tw-prose-invert-rules': colors.gray[700],
  ...
  zinc: {
    css: {
      ...
      '--tw-prose-rules': colors.zinc[200],
      ...
      '--tw-prose-invert-rules': colors.zinc[700],
  ...
  neutral: {
    css: {
      ...
      '--tw-prose-rules': colors.neutral[200],
      ...
      '--tw-prose-invert-rules': colors.neutral[700],
  ...
  stone: {
    css: {
      ...
      '--tw-prose-rules': colors.stone[200],
      ...
      '--tw-prose-invert-rules': colors.stone[700],
