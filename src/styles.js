...
let defaultModifiers = {
  ...
  slate: {
    css: {
      ...
      '--tw-prose-kbd-borders': colors.slate[300],
      ...
      '--tw-prose-invert-kbd-borders': colors.slate[700],
  ...
  gray: {
    css: {
      ...
      '--tw-prose-kbd-borders': colors.gray[300],
      ...
      '--tw-prose-invert-kbd-borders': colors.gray[700],
      '--tw-prose-invert-code': colors.white,
  ...
  zinc: {
    css: {
      ...
      '--tw-prose-kbd-borders': colors.zinc[300],
      ...
      '--tw-prose-invert-kbd-borders': colors.zinc[700],
      '--tw-prose-invert-code': colors.white,
  ...
  neutral: {
    css: {
      ...
      '--tw-prose-kbd-borders': colors.neutral[300],
      ...
      '--tw-prose-invert-kbd-borders': colors.neutral[700],
      '--tw-prose-invert-code': colors.white,
  ...
  stone: {
    css: {
      ...
      '--tw-prose-kbd-borders': colors.stone[300],
      ...
      '--tw-prose-invert-kbd-borders': colors.stone[700],
      '--tw-prose-invert-code': colors.white,
