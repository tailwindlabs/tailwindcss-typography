...
let defaultModifiers = {
  ...
  slate: {
    css: {
      ...
      '--tw-prose-mark': colors.slate[200],
      '--tw-prose-mark-bg': colors.slate[800],
      ...
      '--tw-prose-invert-mark': colors.slate[300],
      '--tw-prose-invert-mark-bg': 'rgb(0 0 0 / 50%)',
  ...
  gray: {
    css: {
      ...
      '--tw-prose-mark': colors.gray[200],
      '--tw-prose-mark-bg': colors.gray[800],
      ...
      '--tw-prose-invert-kbd': colors.white,
      '--tw-prose-invert-kbd-shadows': hexToRgb(colors.white),
      '--tw-prose-invert-mark': colors.gray[300],
      '--tw-prose-invert-mark-bg': 'rgb(0 0 0 / 50%)',
      '--tw-prose-invert-code': colors.white,
  ...
  zinc: {
    css: {
      ...
      '--tw-prose-mark': colors.zinc[200],
      '--tw-prose-mark-bg': colors.zinc[800],
      ...
      '--tw-prose-invert-kbd': colors.white,
      '--tw-prose-invert-kbd-shadows': hexToRgb(colors.white),
      '--tw-prose-invert-mark': colors.zinc[300],
      '--tw-prose-invert-mark-bg': 'rgb(0 0 0 / 50%)',
      '--tw-prose-invert-code': colors.white,
  ...
  neutral: {
    css: {
      ...
      '--tw-prose-mark': colors.neutral[200],
      '--tw-prose-mark-bg': colors.neutral[800],
      ...
      '--tw-prose-invert-kbd': colors.white,
      '--tw-prose-invert-kbd-shadows': hexToRgb(colors.white),
      '--tw-prose-invert-mark': colors.neutral[300],
      '--tw-prose-invert-mark-bg': 'rgb(0 0 0 / 50%)',
      '--tw-prose-invert-code': colors.white,
  ...
  stone: {
    css: {
      ...
      '--tw-prose-mark': colors.stone[200],
      '--tw-prose-mark-bg': colors.stone[800],
      ...
      '--tw-prose-invert-kbd': colors.white,
      '--tw-prose-invert-kbd-shadows': hexToRgb(colors.white),
      '--tw-prose-invert-mark': colors.stone[300],
      '--tw-prose-invert-mark-bg': 'rgb(0 0 0 / 50%)',
      '--tw-prose-invert-code': colors.white,
